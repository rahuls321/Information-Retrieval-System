...
if __name__ == "__main__":
    ...
    ap.add_argument("--vocab_flag", type=int, default=0, help="Do you want to build vocab from scratch for each doc in the courpus \
    ...
    ap.add_argument("--postings_flag", type=int, default=0, help="Do you want to build postings list from scratch for each doc in the corpus \
    ...
    ap.add_argument("-g", "--query_ground_truth", required=True, help="Query ground truth - relevant doc corres. to each query")
    ap.add_argument("--vector_flag", type=int, default=0, help="Do you want to build tf-idf doc vector from scratch for each doc in the courpus \
    ...
    query_ground_truth = args["query_ground_truth"]
